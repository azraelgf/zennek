(() => {
    ...
    (() => {
        ...
        class Popup {
                ...
                document.addEventListener("click", function(e) {
                    ...
                    if (buttonOpen) {
                        ...
                        if (this._dataValue !== "error") {
                            ...
                            this.open();
                            return;
                        } else this.popupLogging(`Упс, не заполнен атрибут у ${buttonOpen.classList}`);
                        return;
                    }
            ...
            open(selectorValue) {
                if (bodyLockStatus) {
                    ...
                    } else this.popupLogging(`Упс, такого попапа нет. Проверьте корректность селектора.`);
                }
            }
            close(selectorValue) {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".reasons__swiper")) resizableSwiper("(max-width: 479.98px)", ".reasons__swiper", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
